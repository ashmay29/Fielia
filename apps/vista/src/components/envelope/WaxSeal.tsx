  ...
  return (
    <div className="relative">
      <div className="relative h-24 w-24 sm:h-28 sm:w-28">
        ...
        <div className="absolute inset-3.5 rounded-full border-[1.5px] border-[#D8CBBB] opacity-70 shadow-[inset_0_1px_2px_rgba(0,0,0,0.6)]" />

        {/* Inner engraved ring */}
        <div className="absolute inset-4.5 rounded-full border border-[#E1D6C7] opacity-60 shadow-[inset_0_1px_1px_rgba(0,0,0,0.5)]" />
