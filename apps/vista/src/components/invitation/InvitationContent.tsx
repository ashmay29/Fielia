  ...
  return (
    <ParchmentBackground>
      <InvitationCard>
        ...
        {/* Main Heading */}
        <h1 className="relative mb-8 font-(family-name:--font-playfair) text-3xl font-semibold tracking-tight text-[#370D10] sm:text-4xl md:text-5xl">
          Welcome to FIELIA
        </h1>

        {/* Body Copy */}
        <div className="relative mb-12 space-y-4 font-(family-name:--font-cormorant) text-base leading-relaxed text-[#370D10]/90 sm:text-lg sm:leading-loose">
          <p>
        ...
        <section className="mb-12 grid gap-10 sm:gap-12 md:grid-cols-3">
          ...
          <div className="group">
            ...
            <div className="mt-3 font-(family-name:--font-cormorant) text-[#501515]">→</div>
          </div>
